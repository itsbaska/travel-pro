...
describe ReceiptsController do
	...
	describe "GET #index" do 
		...
		it "redirects the user to the login page if not logged in and wants to view all the receipts" do
			get :index, params: { trip_id: trip.id } 
	...
	describe "GET #new" do 
		...
		it "redirects the user to the login page if not logged in and wants to create a new receipts" do
			get :new, params: { trip_id: trip.id }
			expect(response).to redirect_to("/login")
		end 
	end 
